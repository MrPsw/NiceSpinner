...
import org.angmarch.views.nicespinner.R;
...
public class NiceSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        gravity = typedArray.getInt(R.styleable.NiceSpinner_android_gravity, -1);
        if (gravity != -1) {
            setGravity(Gravity.CENTER_VERTICAL | gravity);
        } else {
